/**
 * Lock.js - Guardião de Segurança (Gestão Motorista - Trial Version)
...
(function () {
    ...
    function updateLockScreen(expired) {
        ...
        if (expired) {
            ...
            // Bloqueia qualquer tentativa de fechar (se houver)
        }
    }

    document.addEventListener('DOMContentLoaded', function () {
        if (isLicensed()) {
            return; // Licenciado, segue vida normal
        }
        ...
        if (trial.expired) {
            ...
            const header = document.querySelector('header'); // Esconde header também
    ...
    // Expor função para verificação manual se necessário
