...
// V1.0 - Product-Led Growth System
...
// CONFIG
$ADMIN_SECRET = "Rein@ldo1912"; // Mesma senha do admin principal por enquanto
...
if ($action === 'list_coupons') {
    if (($jsonData['secret'] ?? '') !== $ADMIN_SECRET) {
...
$MP_ACCESS_TOKEN = "APP_USR-2857913492720459-021618-d2fa8b61ae535b334d4cdd28f720880c-3202258925";
$NOTIFICATION_URL = "https://sistemasdegestao.tech/api_vendas.php?action=webhook";
